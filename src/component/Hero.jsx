                ...
                <div className="hero-container justify-content-end d-flex ">
                    ...
                    <div id="carouselExampleInterval" className="carousel slide carousel-fade" data-bs-ride="carousel">
                        ...
                        <div className="carousel-inner">
                            <div className="carousel-item active" data-bs-interval="10000">
                                <img src="/public/images/clothModel-image.avif" className="d-block w-100" alt="..." />
                                <div className="carousel-caption text-start d-none d-md-block">
                                    ...
                                    <Link to="/shop/clothing"><button className='btn btn-outline-primary btn-sm fw-semibold text-uppercase'>buy now</button></Link>
                                </div>
                            </div>
                            <div className="carousel-item" data-bs-interval="2000">
                                <img src="/public/images/camera-Image.avif" className="d-block w-100" alt="..." />
                                <div className="carousel-caption text-start d-none d-md-block">
                                    <h6>Cameras</h6>
                                    <h1>Sony IMX Cameras</h1>
                                    <p className='text-uppercase'>all top companies cameras available.</p>
                                    <Link to="/"><button className='btn btn-outline-primary btn-sm fw-semibold  text-uppercase'>buy now</button></Link>
                                </div>
                            </div>
                            <div className="carousel-item">
                                <img src="/public/images/mobile-image.avif" className="d-block w-100" alt="..." />
                                <div className="carousel-caption text-start d-none d-md-block">
                                    <h6>Mobiles</h6>
                                    <h1>New Arrivels</h1>
                    ...
                    <div className="offer-box " >
                        <div className="col">
                            <div className="card " >
                                <Link to="/fashion">
                                    <img src="/public/images/clothModel-3.avif" className="card-img-top" alt="..." />
                                    <div className="text">
                                        <h6>clothing</h6>
                            ...
                            <div className="card" >
                                <Link to="/gadgets">
                                    <img src="/public/images/Headsets.webp" className="card-img-top" alt="..." />
                                    <div className="text">
                                        <h6>gadgets</h6>
                        ...
                        <div className="col">
                            <div className="card" >
                                <Link to="/electronics">
                                    <img src="/public/images/camera-2.webp" className="card-img-top" alt="..." />
                                    <div className="text">
                                        <h6>electonics</h6>
                            ...
                            <div className="card" >
                                <Link to="/beauty">
                                    <img src="/public/images/makeup-image.jpeg" className="card-img-top" alt="..." />
                                    <div className="text">
                                        <h6>beauty</h6>
