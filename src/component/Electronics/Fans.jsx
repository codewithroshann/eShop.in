  ...
  return (
    ...
    <div className="shop-product px-4">
        ...
        <ProductModule/>
            ...
            <div className="tab-content pb-5 mt-4 position-relative">
                {
                    allProduct.filter(items => items.category_3 === "fans").map((data,key) => {
                        return <div className="tab-product clothing-tab position-relative" key={key}>
                            <div className="title">
                                <small>
                                    {data.link}
                                </small>
